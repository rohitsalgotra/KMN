...
switch F
    ...
    case 'F8'% as per NMRA paper test suite
        fobj = @F8;
        lb=-5.12;
        ub=5.12;
        dim=30;
...
%         dim=2;
    ...
    case 'F13'
        fobj = @F13; % as per test suite used in ADA
        lb=-2;
        ub=2;
        dim=30;
        
    case 'F14'
        fobj = @F14; % as per test suite used in ADA
        lb=0;
        ub=1;
        dim=3;
        
    case 'F15' % as per test suite used in ADA
        fobj = @F15;
        lb=0;
        ub=1;
        dim=6;     
